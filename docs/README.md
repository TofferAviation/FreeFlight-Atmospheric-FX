...
- [ACF_PARSER_SUBSYSTEM_SPEC.md](ACF_PARSER_SUBSYSTEM_SPEC.md) — exact ACF parser responsibilities, interfaces, dependencies, threading, budgets, validation, and implementation sequence.
